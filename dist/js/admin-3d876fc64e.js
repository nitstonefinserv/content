...
},{"./components/FileGrid.vue":6,"./components/FileListComponent.vue":7,"./components/ImageComponent.vue":8,"./components/ImageGalleryComponent.vue":9,"./components/ImageGrid.vue":10,"./components/ModalImageBrowser.vue":11,"./components/UploadButton.vue":12}],6:[function(require,module,exports){
(function (global){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 3, stdin */\n.content-files-grid .file {\n  border: 1px solid #ddd;\n  border-radius: 2px;\n  margin: 5px;\n  padding: 4px; }\n  /* line 4, stdin */\n  .content-files-grid .file h5 {\n    overflow: hidden;\n    line-height: 1.5; }\n  /* line 8, stdin */\n  .content-files-grid .file .close {\n    margin-top: 8px; }\n")
'use strict';
...
exports.default = {
	...
	props: ['api_content_files_lookup', 'api_content_file_delete'],
	...
	methods: {
		setColumnSize: function setColumnSize(viewport) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-411cff4e", module.exports)
  } else {
    hotAPI.update("_v-411cff4e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],7:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 3, stdin */\n.file-list-component .file {\n  border: 1px solid #ddd;\n  border-radius: 2px;\n  width: 100%;\n  margin: 5px;\n  padding: 4px;\n  clear: both; }\n  /* line 4, stdin */\n  .file-list-component .file h5 {\n    overflow: hidden;\n    line-height: 1.5;\n    margin-top: 0; }\n    /* line 8, stdin */\n    .file-list-component .file h5 .editable {\n      margin-top: 0; }\n  /* line 12, stdin */\n  .file-list-component .file .close {\n    margin-top: 0; }\n\n/* line 24, stdin */\n.file-list-component .controls {\n  clear: both; }\n")
'use strict';
...
exports.default = {
	...
	methods: {
		...
		getIDString: function getIDString() {
			var ids = [];
			for (var i = 0; i < this.files.length; i++) {
		...
		addJQueryPlugins: function addJQueryPlugins() {
			var self = this,
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"file-list-component\">\n    \t<div class=\"file-list\">\n            <div class=\"file\" v-for=\"file in files\" v-bind:data-id=\"file.id\">\n                <button type=\"button\" class=\"close\" v-on:click=\"deleteFile(file)\" aria-label=\"Delete\"><span>×</span></button>\n\t\t\t\t<h5>\n\t\t\t\t\t<a class=\"editable\" data-type=\"text\" data-name=\"name\" data-title=\"Enter Name\" v-bind:data-pk=\"file.id\">{{file.name}}</a>\n\t\t\t\t\t<a v-bind:href=\"file.url\"><span class=\"fa fa-download\"></span></a>\n            \t</h5>\n\t\t\t\t<p><a class=\"editable\" data-type=\"textarea\" data-name=\"description\" data-title=\"Enter Description\" data-placeholder=\"Description\" v-bind:data-pk=\"file.id\">{{file.description}}</a></p>\n\t\t\t\t<div style=\"clear:both\"></div>\n            </div>\n        </div>\n\n        <input type=\"hidden\" v-bind:name=\"attribute\" v-bind:value=\"getIDString()\">\n\n        <div class=\"controls\">\n\t        <div v-if=\"error\" class=\"alert alert-danger\">{{error}}</div>\n\t        <small>Max upload size: {{ upload_max }}</small>\n\t        <content-upload-button v-on:fail=\"uploadError\" v-on:done=\"addFile\" :attribute=\"attribute\" :upload_url=\"upload_url\" :upload_max=\"upload_max\" :upload_max_bytes=\"upload_max_bytes\" :upload_path_prefix=\"upload_path_prefix\" :upload_url_prefix=\"upload_url_prefix\"></content-upload-button>\n\t\t</div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-c884c408", module.exports)
  } else {
    hotAPI.update("_v-c884c408", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],8:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 3, stdin */\n.image-field .current_image {\n  max-height: 100px;\n  mad-width: 100px; }\n\n/* line 7, stdin */\n.image-field .btn-link, .image-field .btn-link:hover {\n  background: none !important;\n  border: none; }\n\n/* line 11, stdin */\n.image-field .controls {\n  clear: both; }\n")
'use strict';
...
exports.default = {
	...
	methods: {
		openSelectImageBrowser: function openSelectImageBrowser() {
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"image-field\">\n        <template v-if=\"current_image\">\n        \t<p>\n\t            </p><h5>{{current_image.name}}</h5>\n\t\t        <img class=\"current_image\" v-bind:src=\"current_image.url\">\n\t        \t<input type=\"hidden\" name=\"{{attribute}}\" v-bind:value=\"current_image.id\">\n\t        <p></p>\n        </template>\n        <div class=\"input-group\">\n            <a class=\"btn btn-default select-image\" v-on:click=\"openSelectImageBrowser()\">\n            \tSelect Image <i class=\"fa fa-picture-o\"></i>\n            </a>\n            <a class=\"btn btn-link\" v-if=\"current_image\" v-on:click=\"clearImage()\">Clear {{label}}</a>\n        </div>\n\n        <content-modal-image-browser v-on:select-image=\"selectImage\" v-on:delete-image=\"deleteImage\" :label=\"label\" :attribute=\"attribute\" :upload_url=\"upload_url\" :upload_max=\"upload_max\" :upload_max_bytes=\"upload_max_bytes\" :upload_path_prefix=\"upload_path_prefix\" :upload_url_prefix=\"upload_url_prefix\" :api_content_images_lookup=\"api_content_images_lookup\" :api_content_file_delete=\"api_content_file_delete\"></content-modal-image-browser>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-69351fce", module.exports)
  } else {
    hotAPI.update("_v-69351fce", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],9:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 3, stdin */\n.image-gallery .image {\n  width: 100%;\n  margin: 5px;\n  clear: both; }\n  /* line 4, stdin */\n  .image-gallery .image h5 {\n    overflow: hidden;\n    line-height: 1.5;\n    margin-top: 0; }\n    /* line 8, stdin */\n    .image-gallery .image h5 .editable {\n      margin-top: 0; }\n  /* line 12, stdin */\n  .image-gallery .image .close {\n    margin-top: 8px; }\n  /* line 15, stdin */\n  .image-gallery .image img {\n    max-height: 100px;\n    max-width: 100px;\n    float: left;\n    margin-right: 5px; }\n  /* line 21, stdin */\n  .image-gallery .image .close {\n    margin-top: 0; }\n\n/* line 29, stdin */\n.image-gallery .controls {\n  clear: both; }\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"image-gallery\">\n    \t<div class=\"image-list\">\n            <div class=\"image thumbnail\" v-for=\"image in images\" v-bind:data-id=\"image.id\">\n            \t<img v-bind:src=\"image.url\">\n                <button type=\"button\" class=\"close\" v-on:click=\"deleteImage(image)\" aria-label=\"Delete\"><span>×</span></button>\n\t\t\t\t<h5><a class=\"editable\" data-type=\"text\" data-name=\"name\" data-title=\"Enter Name\" v-bind:data-pk=\"image.id\">{{image.name}}</a></h5>\n\t\t\t\t<p><a class=\"editable\" data-type=\"textarea\" data-name=\"description\" data-title=\"Enter Description\" data-placeholder=\"Description\" v-bind:data-pk=\"image.id\">{{ image.description }}</a></p>\n\t\t\t\t<p><a class=\"editable\" data-type=\"text\" data-name=\"link\" data-title=\"Enter url to link to\" v-bind:data-pk=\"image.id\">{{ image.link }}</a></p>\n\t\t\t\t<div style=\"clear:both\"></div>\n            </div>\n        </div>\n\n        <input type=\"hidden\" v-bind:name=\"attribute\" v-bind:value=\"getIDString()\">\n\n        <div class=\"controls\">\n\t        <div v-if=\"error\" class=\"alert alert-danger\">{{error}}</div>\n\t        <small>Max upload size: {{ upload_max }}</small>\n\n\t        <content-upload-button v-on:fail=\"uploadError\" v-on:done=\"addFile\" :attribute=\"attribute\" :upload_url=\"upload_url\" :upload_max=\"upload_max\" :upload_max_bytes=\"upload_max_bytes\" :upload_path_prefix=\"upload_path_prefix\" :upload_url_prefix=\"upload_url_prefix\"></content-upload-button>\n\t\t</div>\n    </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-490e235f", module.exports)
  } else {
    hotAPI.update("_v-490e235f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],10:[function(require,module,exports){
(function (global){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 4, stdin */\n.content-image-grid .image h5 {\n  overflow: hidden;\n  line-height: 1.5; }\n\n/* line 8, stdin */\n.content-image-grid .image .close {\n  margin-top: 8px; }\n")
'use strict';
...
exports.default = {
	...
	props: ['api_content_images_lookup', 'api_content_file_delete'],
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5078715a", module.exports)
  } else {
    hotAPI.update("_v-5078715a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],11:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 4, stdin */\n.content-modal-image-browser .image h5 {\n  overflow: hidden;\n  line-height: 1.5; }\n\n/* line 8, stdin */\n.content-modal-image-browser .image .close {\n  margin-top: 8px; }\n")
'use strict';
...
exports.default = {
	...
	props: ['label', 'attribute', 'upload_url', 'upload_max', 'upload_max_bytes', 'upload_path_prefix', 'upload_url_prefix', 'api_content_images_lookup', 'api_content_file_delete'],
	...
	methods: {
		...
		closeSelectImageBrowser: function closeSelectImageBrowser() {
			this.browsing = false;
		},
		selectImage: function selectImage(image) {
			this.browsing = false;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f39cad9a", module.exports)
  } else {
    hotAPI.update("_v-f39cad9a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":3,"vue-hot-reload-api":2,"vueify/lib/insert-css":4}],12:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("/* line 2, stdin */\n.upload-button {\n  display: inline; }\n  /* line 3, stdin */\n  .upload-button .btn-upload {\n    position: relative;\n    overflow: hidden; }\n  /* line 7, stdin */\n  .upload-button input.fileupload {\n    position: absolute;\n    top: 0;\n    right: 0;\n    margin: 0;\n    padding: 0;\n    font-size: 20px;\n    cursor: pointer;\n    opacity: 0;\n    filter: alpha(opacity=0); }\n")
'use strict';
...
exports.default = {
	props: ['attribute', 'upload_url', 'upload_max', 'upload_max_bytes', 'upload_path_prefix', 'upload_url_prefix'],
	ready: function ready() {
		// start file upload
		var self = this,
		...
		input.fileupload({
			...
			formData: {
				path_prefix: self.upload_path_prefix,
				url_prefix: self.upload_url_prefix,
				group: self.attribute
			},
			start: function start(e, data) {
				parent.addClass('disabled');
				parent.find('.fa').removeClass('fa-plus').addClass('fa-refresh').addClass('fa-spin');
				self.$emit('start');
			},
			fail: function fail(e, data) {
				parent.removeClass('disabled');
				parent.find('.fa').addClass('fa-plus').removeClass('fa-refresh').removeClass('fa-spin');
				self.$emit('fail');
			},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-06443e0a", module.exports)
  } else {
    hotAPI.update("_v-06443e0a", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
